...
include(":mod6demoroom")
include(":mod6corrroomunittest")
include(":mod7demoretrofit")
include(":mod7corrretrofit")
include(":mod8demoworkmanager")
include(":mod8corrworkmanager")
include(":mod9localisation")
